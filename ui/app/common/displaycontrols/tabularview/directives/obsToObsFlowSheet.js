        ...
        var link = function ($scope, element) {
            ...
            $scope.commafy = function (observations) {
                ...
                for (var index in observations) {
                    ...
                    else if (observations[index].concept.dataType === "Date") {
                    ...
                    else if (observations[index].concept.dataType === "Datetime") {
                        var conceptName = observations[index].concept.name;
                        if (conceptName && config[conceptName] && config[conceptName].displayMonthAndYear == true) {
                            name = Bahmni.Common.Util.DateUtil.getDateInMonthsAndYears(name);
                        } else {
                            var ethDate = Bahmni.Common.Util.DateUtil.gregToEthMonthName(moment(name).format("MM/DD/YYYY"));
                            name = Bahmni.Common.Util.DateUtil.formatDateWithoutTime(name) + " (" + ethDate + ")";
                        }
                    }
