...
Bahmni.Common.PatientSearch.Constants = {
    ...
    tabularViewIgnoreHeadingsList: ["tokenSequence", "currentToken", "queueLocationAssignmentId", "tokenId", "queueId", "display", "uuid", "image", "$$hashKey", "activeVisitUuid", "hasBeenAdmitted", "forwardUrl", "programUuid", "enrollment"],
