    ...
    .controller('AppointmentsListViewController', ['$scope', '$state', '$rootScope', '$translate', '$stateParams', 'spinner',
        ...
        function ($scope, $state, $rootScope, $translate, $stateParams, spinner, appointmentsService, appService,
            ...
            $scope.tableInfo = [{heading: 'APPOINTMENT_PATIENT_ID', sortInfo: 'patient.identifier', enable: true},
                ...
                {heading: 'APPOINTMENT_CREATOR', sortInfo: 'creator.name', enable: true},
                {heading: 'APPOINTMENT_DATE_CREATED', sortInfo: 'createDate', enable: true},
                {heading: 'APPOINTMENT_WALK_IN', sortInfo: 'appointmentKind', enable: false},
                {heading: 'APPOINTMENT_SERVICE_LOCATION_KEY', sortInfo: 'location.name', class: true, enable: false},
            ...
            $scope.getAppointmentsForDate = function (viewDate) {
                ...
                // var params = {forDate: Bahmni.Common.Util.DateUtil.parseLongDateToServerFormat(viewDate)};
